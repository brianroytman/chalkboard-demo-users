...
class TestUserRoutes(unittest.TestCase):
    ...
    async def test_get_user(self, mock_get_user):
        mock_get_user.return_value = {'id': 1, 'username': 'John Doe', 'email': 'johnnydoe@gmail.com', 'first_name': 'John', 'last_name': 'Doe'}
    ...
    async def test_update_user(self, mock_update_user):
        mock_update_user.return_value = {'id': 1, 'username': 'John Doe', 'email': 'johnnydoe@gmail.com', 'first_name': 'John', 'last_name': 'Doe'}
        response = await self.client.put('/users/1', json={'username': 'John Doe', 'email': 'johnnydoe@gmail.com', 'first_name': 'John', 'last_name': 'Doe'})
        self.assertEqual(response.status_code, 200)
        self.assertEqual(response.json(), {'id': 1, 'username': 'John Doe', 'email': 'johnnydoe@gmail.com', 'first_name': 'John', 'last_name': 'Doe'})
        mock_update_user.assert_called_once_with(1, {'username': 'John Doe', 'email': 'johnnydoe@gmail.com', 'first_name': 'John', 'last_name': 'Doe'}, session=AsyncMock())
